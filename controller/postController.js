...
const uploadFromBuffer = require("../middleware/uploadFromBuffer");
...
exports.createPost = async (req, res) => {
  ...
  try {
    ...
    const imageResult = await uploadFromBuffer(imageUri.data, {
      folder: "posts",
      transformation: [
    ...
    const thumbnailPromises = Array.isArray(thumbnails)
      ...
      : [
          uploadFromBuffer(thumbnails.data, {
            folder: "posts",
            transformation: [
              { width: 1000, crop: "scale" },
              { quality: "auto:best" },
